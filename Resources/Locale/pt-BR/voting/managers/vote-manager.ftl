...
ui-vote-restart-fail-not-enough-ghost-players =
    Restart vote failed: Um mínimo de { $ghostPlayerRequirement }% jogadores fantasmas é necessário para iniciar uma votação de reinicialização. Atualmente, não há jogadores fantasmas suficientes.
