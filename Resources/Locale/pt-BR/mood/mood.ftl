...
mood-effect-NicotineBenefit = Sinto como se tivesse ficado de pé a vida inteira e simplesmente me sentei.
mood-effect-NicotineWithdrawal = Eu realmente gostaria de fumar um cigarro agora.
# Surgery
mood-effect-SurgeryPain = A cirguria doi.
# Drugs
mood-effect-EthanolBenefit = Me sinto tão relaxado depois de beber.
mood-effect-SpaceDrugsBenefit = Woaaaah, que cores lindas, caraaaaaa. É como se eu pudesse ouvir a cor e o gosto do som, bro.
