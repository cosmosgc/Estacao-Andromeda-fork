...
psionic-regeneration-power-initialization-feedback = Olho dentro de mim mesmo, encontrando uma fonte de vida.
...
action-description-shadeskip = Invoque os senhores do sim dos sempos e suplique-lhes por um fragmento da verdadeira entropia.
...
action-description-telekinetic-pulse = Force todos ao seu redor para longe.
...
action-description-summon-imp = Invoca e vincula um Imp de Gehenna para servir como seu Familiar.
...
action-description-summon-remilia = Invoque sua sempre leal familiar Remilia.
...
ghost-role-information-familiar-rules = Obedeça quem te convocou. Não aja contra os interesses do seu mestre. Você morrerá pelo seu mestre se for necessário.
